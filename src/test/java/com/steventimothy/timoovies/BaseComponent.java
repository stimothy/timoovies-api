...
//  }
//
//  protected SessionId loginUser(User user) {
//    ResponseEntity<SessionId> responseEntity = requestLoginUser(user);
//
//    assertStatus(responseEntity, HttpStatus.OK);
//    assertThat(responseEntity.getBody().getEncodedValue())
//        .isNotNull();
...
//  }
//
//  protected ResponseEntity<SessionId> requestLoginUser(User user) {
//    return this.restTemplate.exchange(RequestEntity.post(UriComponentsBuilder.fromUriString(getUasPath())
//        .build().toUri())
//        .accept(MediaType.APPLICATION_JSON)
//        .contentType(MediaType.APPLICATION_JSON)
//        .body(user), SessionId.class);
//  }
//
//  /**
...
//  }
//
//  protected String getAdminAmsPath() {
//    return getAmsPath() + "/admin";
//  }
//
//  /**
//   * Returns the ams base path.
